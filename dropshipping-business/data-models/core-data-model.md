...
|---|---|---|
| Product | Item sold in the store | title, description, category, status, supplier, images, SEO fields |
| Variant | Sellable version of a product | SKU, option values, price, compare-at price, cost, weight, barcode |
| Supplier | Company or platform that fulfils products | name, contact, API type, reliability score, shipping regions |
| Supplier Product | Supplier-side product record | supplier SKU, supplier cost, supplier stock, processing time, source URL |
