...
This glossary defines the technical and business-system terms used in the project.

## Terms

- Affiliate model: a model where the business sends customers to another authorized seller and earns commission if a sale happens.
- API: a structured way for one software system to talk to another.
- Architecture: the design of how system parts connect and work together.
- Attribution: identifying which marketing source caused a visit, sale, or customer action.
...
- Workflow: a repeatable sequence of actions.
